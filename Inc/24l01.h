...
/** 配置和选项定义 */
#define NRF_DYNAMIC_PACKET      0 		//1:动态数据包, 0:固定
#define NRF_FIXED_PACKET_LEN    32		//包长度
#define NRF_REPEAT_CNT          0		//重复次数
...
/** RF24L01硬件接口定义 */
 ...
 /* 定义位操作 前提是引脚设置为输出功能 */
//24L01操作线
#define NRF24L01_CE   NRF_CE_Pin //24L01片选信号
#define NRF24L01_CSN  NRF_CS_Pin //SPI片选信号	   




/** 口线操作函数定义 */
#define RF24L01_SET_CE_HIGH( )			{NRF_CE_GPIO_Port->BSRR = NRF24L01_CE;}
#define RF24L01_SET_CE_LOW( )			{NRF_CE_GPIO_Port->BRR = NRF24L01_CE;}

#define RF24L01_SET_CS_HIGH( )			{NRF_CS_GPIO_Port->BSRR = NRF24L01_CSN;}
#define RF24L01_SET_CS_LOW( )			{NRF_CS_GPIO_Port->BRR = NRF24L01_CSN;}

#define RF24L01_GET_IRQ_STATUS( )		(( GPIOB->IDR&NRF24L01_IRQ ) ? 1 : 0 )
