...
/** RF24L01硬件接口定义 */
 ...
 /* 定义位操作 前提是引脚设置为输出功能 */
//24L01操作线
#define NRF24L01_CE   GPIO_Pin_9 //24L01片选信号
#define NRF24L01_CSN  GPIO_Pin_15 //SPI片选信号	   
#define NRF24L01_IRQ  GPIO_Pin_8  //IRQ主机数据输入

//#define NRF24L01_SCK   GPIO_Pin_9 //
//#define NRF24L01_MISO  GPIO_Pin_9 //   
//#define NRF24L01_MOSI  GPIO_Pin_9 //


/** 口线操作函数定义 */
#define RF24L01_SET_CE_HIGH( )			{GPIOB->BSRR |= NRF24L01_CE;}
#define RF24L01_SET_CE_LOW( )			{GPIOB->BRR |= NRF24L01_CE;}

#define RF24L01_SET_CS_HIGH( )			{GPIOA->BSRR |= NRF24L01_CSN;}
#define RF24L01_SET_CS_LOW( )			{GPIOA->BRR |= NRF24L01_CSN;}
